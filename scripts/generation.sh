...
#SBATCH --output=/srv/nlprx-lab/share6/dhe83/mice/experiments/outputs/%Ageneration.out
#SBATCH --error=/srv/nlprx-lab/share6/dhe83/mice/experiments/outputs/%Ageneration.err
#SBATCH --gres=gpu:1
